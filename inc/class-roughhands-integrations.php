...
if ( ! class_exists( 'RoughHands_Integrations' ) ) :
	/**
	 * RoughHands_Integrations main class
	 */
	class RoughHands_Integrations {
...
return new RoughHands_Integrations();
